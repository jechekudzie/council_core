        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#sidebarDashboards" data-bs-toggle="collapse"
                           ...
                           aria-expanded="false" aria-controls="sidebarDashboards">
                             <span data-key="t-dashboards">Registration Utilities</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('/admin/professions')}}" class="nav-link {{(request()->is('admin/professions*')) ? 'active' : '' }}" data-key="t-analytics">
                                        PROFESSIONS </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/profession_qualifications')}}" class="nav-link {{(request()->is('admin/profession_qualifications*')) ? 'active' : '' }}"
                                       data-key="t-ecommerce"> PROFESSIONAL QUALIFICATION</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/registers')}}" class="nav-link {{(request()->is('admin/registers*')) ? 'active' : '' }}" data-key="t-crypto">
                                        REGISTERS </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/institutions')}}" class="nav-link {{(request()->is('admin/institutions*')) ? 'active' : '' }}" data-key="t-crypto">
                                        INSTITUTIONS </a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{url('/admin/qualification_categories')}}" class="nav-link {{(request()->is('admin/qualification_categories*')) ? 'active' : '' }}" data-key="t-crypto">
                                        QUALIFICATION CATEGORIES </a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{url('/admin/requirement_categories')}}" class="nav-link {{(request()->is('admin/requirement_categories*')) ? 'active' : '' }}" data-key="t-crypto">
                    ...
                    <!-- payment utilities -->
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#payment_utilities" data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="false" aria-controls="payment_utilities">
                             <span data-key="t-dashboards">Payment Utilities</span>
                        </a>
                        <div class="collapse menu-dropdown" id="payment_utilities">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('/admin/payment_categories')}}" class="nav-link {{(request()->is('admin/payment_categories*')) ? 'active' : '' }}" data-key="t-analytics">
                                        PAYMENT CATEGORIES </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/restorations')}}" class="nav-link {{(request()->is('admin/restorations*')) ? 'active' : '' }}"
                                       data-key="t-ecommerce"> RESTORATIONS</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/penalties')}}" class="nav-link {{(request()->is('admin/penalties*')) ? 'active' : '' }}" data-key="t-crypto">
                                        PENALTIES </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <!-- status utilities -->
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#statuses_utilities" data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="false" aria-controls="statuses_utilities">
                            <span data-key="t-dashboards">Status Utilities</span>
                        </a>
                        <div class="collapse menu-dropdown" id="statuses_utilities">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('/admin/restorations')}}" class="nav-link {{(request()->is('admin/restorations*')) ? 'active' : '' }}"
                                       data-key="t-ecommerce"> COMPLIANCE STATUSES</a>
                                </li>
                    ...
                    <!-- contact utilities -->
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#contact_utilities" data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="false" aria-controls="contact_utilities">
                            <span data-key="t-dashboards">Contact Utilities</span>
                        </a>
                        <div class="collapse menu-dropdown" id="contact_utilities">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('/admin/restorations')}}" class="nav-link {{(request()->is('admin/restorations*')) ? 'active' : '' }}"
                                       data-key="t-ecommerce"> COUNTRIES</a>
                                </li>
                    ...
                    <!-- reports utilities -->
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed" href="#reports_utilities" data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="false" aria-controls="reports_utilities">
                             <span data-key="t-dashboards">Reports</span>
                        </a>
                        <div class="collapse menu-dropdown" id="reports_utilities">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('/admin/professions')}}" class="nav-link {{(request()->is('admin/professions*')) ? 'active' : '' }}" data-key="t-analytics">
                                        PROFESSIONS </a>
